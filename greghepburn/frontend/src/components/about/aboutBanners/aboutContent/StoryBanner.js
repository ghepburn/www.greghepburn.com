			...
			<section id="section-a" className="grid">
				<div className="content-wrap">
					...
					<div className="content-text">
						...
						<p>My favorite job was at a local campground.  I worked 40+ hour weeks as an assistant manager, ensuring customer satisfaction and "YouTubing" "How-To" videos for each days new problem.</strong></p>
